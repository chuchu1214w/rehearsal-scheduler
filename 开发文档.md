...
> **版本** v1.5 · **日期** 2026-09-21 · **状态** 需求已确认;**M0、M1 已完成**,M2 起未开始
...
| **M1** 账号与基础数据 ✅ **已完成(2026-09-21)** | 登录、邀请、活动、名册、曲目 | FastAPI 后端(AUTH-01~06、EVT-01~03、ROS-01、SONG-01~03);React 前端(首次设置、登录、邀请、活动、曲目、名册、账号页,按 §7.3 风格);24 个接口测试;一键启动与演示数据脚本 | 权限矩阵测试从 OpenAPI 枚举全部端点,匿名 401 / 成员 403 ✅;手机与桌面视口人工核对 ✅ | M |
